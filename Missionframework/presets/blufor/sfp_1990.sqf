...
infantry_units = [
	["sfp_1990_m90w_rifleman_ak5",15,0,0],								//Rifleman (Light)
	["sfp_1990_m90w_rifleman_ak5",20,0,0],									//Rifleman
	["sfp_1990_m90w_at_specialist_pskott86",30,0,0],							//Rifleman (AT)
	["sfp_1990_m90w_gr",25,0,0],												//Grenadier
	["sfp_1990_m90w_automaticrifleman_ksp90",25,0,0],						//Autorifleman
	["sfp_1990_m90w_machinegunner_ksp58",35,0,0],							//Heavygunner
	["sfp_1990_m90w_marksman",30,0,0],										//Marksman
//	["sfp_m90w_at_specialist_rb57",50,10,0],							//AT Specialist
	["sfp_1990_m90w_at_specialist_grg86",50,10,0],							//AT Specialist
	["sfp_1990_m90w_at_loader_grg86",50,10,0],							//AT Specialist
//	["rhsusf_army_ocp_aa",50,10,0],										//AA Specialist
	["sfp_1990_m90w_medic",30,0,0],											//Combat Life Saver
	["sfp_1990_m90w_engineer",30,0,0],										//Engineer
	["sfp_1990_m90w_explosive_specialist",30,0,0],							//Explosives Specialist
	["sfp_1990_m90w_bassak_teamleader",20,0,0],										//Recon Rifleman
	["sfp_1990_m90w_bassak_at_specialist",30,0,0],							//Recon Rifleman (AT)
	["sfp_1990_m90w_bassak_ksp90",25,0,0],										//Recon Autorifleman
	["sfp_1990_m90w_bassak_machinegunner_ksp58",35,0,0],						//Recon Machine Gunner
	["sfp_1990_m90w_bassak_marksman",30,0,0],										//Recon Marksman
	["sfp_1990_m90w_bassak_ag90",70,5,0],								//Recon Sniper (M107)
//	["rhsusf_army_ocp_sniper",70,5,0],									//Sniper
	["sfp_1990_m90w_bassak_ag90",70,5,0],									//Sniper (M107)
	["sfp_1990_m90w_sniper",70,5,0],											//Sniper (M24 SWS)
	["sfp_1990_m90w_crew",10,0,0],											//Crewman
//	["rhsusf_army_ocp_rifleman_101st",20,0,0],							//Para Trooper
	["sfp_1990_m90w_helipilot",10,0,0],										//Helicopter Pilot
	["sfp_m90w_pilot",10,0,0]											//Pilot
];

// [ "classname", supply, ammo, fuel ]
light_vehicles = [
//	["B_Quadbike_01_F",50,0,25],										//Quad Bike
//	["sfp_tgb16",100,0,50],												//M1025A2
//	["sfp_tgb16_rws",100,40,50],										//M1025A2 (M2)
	["sfp_tgb11",50,0,25],												//M1025A2 (Mk19)
	["sfp_tgb1111",100,25,50],											//M1097A2 (2D / open back)
	["sfp_tgb1112",100,0,50],											//M1097A2 (2D)
	["sfp_tgb1111_sog_ksp58",120,40,60],								//M1220
	["sfp_tgb1111_sog_rbs56",120,40,60],								//M1220 (M2)
	["sfp_tgb13",75,0,25],												//M1232
	["sfp_tgb13_ksp58",75,20,25],										//M1220 (Mk19)
	["sfp_tgb1314",100,0,60],											//M1232 (M2)
	["sfp_tgb1317",100,0,60],											//M1232 (Mk19)
	["sfp_tgb20",120,0,50],												//M1230A1 (MEDEVAC)				
...
//	["B_UGV_01_F",150,0,50],											//UGV Stomper
	["sfp_gruppbat",20,0,10],											//UGV Stomper (RCWS)
...
blufor_squad_inf_light = [
	"sfp_1990_m90w_squadleader",
	"sfp_1990_m90w_automaticrifleman_ksp90",
	"sfp_1990_m90w_rifleman_ak5",
...
blufor_squad_inf = [
	"sfp_1990_m90w_squadleader",
	"sfp_1990_m90w_machinegunner_ksp58",
	"sfp_1990_m90w_at_specialist_grg86",
	"sfp_1990_m90w_at_loader_grg86",
	"sfp_1990_m90w_teamleader",
	"sfp_1990_m90w_machinegunner_ksp58",
	"sfp_1990_m90w_at_specialist_grg86",
	"sfp_1990_m90w_at_loader_grg86"
...
elite_vehicles = [
	"sfp_ikv91",														//Mk.V SOCOM
	"sfp_strv103c",														//M1A1SA (Tusk I)
