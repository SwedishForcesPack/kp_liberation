switch (KP_liberation_preset_blufor) do {
	...
	case 9: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\sfp.sqf";};
	case 10: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\sfp_1990.sqf";};
