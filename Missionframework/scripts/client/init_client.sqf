...
switch (KP_liberation_arsenal) do {
	...
	case 7: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\sfp.sqf";};
	case 8: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\sfp_1990.sqf";};
